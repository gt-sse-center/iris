...
@pytest.mark.parametrize("bad", ["lambda x: x", "__import__('os')", "eval('1')", "a; b", "except: pass"])
...
@pytest.mark.parametrize("fake_img,ans", [
    ({'file1': {'B1': 1, 'B2': 2}, 'file2': {'R': 1}}, ['$file1.B1', '$file1.B2', '$file2.R']),
    ({'c3': 1}, ['c3']),
