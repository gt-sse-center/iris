...
class TestLaunchCommand:
    ...
    def test_launch_existing_project(self, tmp_path):
    ...
    def test_launch_creates_new_project(self, tmp_path):
    ...
    def test_launch_no_config_raises_error(self, tmp_path):
...
class TestRmCommand:
    ...
    def test_rm_with_confirmation(self, tmp_path):
    ...
    def test_rm_cancelled(self, tmp_path):
